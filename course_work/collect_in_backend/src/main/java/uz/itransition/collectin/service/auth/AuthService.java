package uz.itransition.collectin.service.auth;
...
import uz.itransition.collectin.exception.jwt.JwtValidationException;
...
//    public JwtTokenResponse getAccessToken(String refreshToken) {
//        String email = jwTokenProvider.validateRefreshToken(refreshToken);
...
//                    optionalUser.get().getImageUrl(),
//                    jwTokenProvider.generateAccessToken(optionalUser.get()), refreshToken);
